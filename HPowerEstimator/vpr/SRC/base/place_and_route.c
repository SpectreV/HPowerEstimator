...
/* This routine controls the overall placement and routing of a circuit. */
    ...
    float **net_delay, **net_slack, T_crit;
    ...
    else
	{
	    ...
	    else
		{
			...
			T_crit = routing_stats(router_opts.full_stats, router_opts.route_type,
		    ...
		    print_route(route_file, T_crit, width_fac);
 ...
 * fail.                                                              */
    ...
    T_crit = routing_stats(full_stats, router_opts.route_type,
		  det_routing_arch.num_switch, segment_inf,
		  det_routing_arch.num_segment,
		  det_routing_arch.R_minW_nmos,
		  det_routing_arch.R_minW_pmos,
    ...
    print_route(route_file, T_crit, final);
