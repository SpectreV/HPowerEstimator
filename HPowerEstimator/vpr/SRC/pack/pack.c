...
void try_pack(INP struct s_packer_opts *packer_opts, INP const t_arch * arch, INP t_model *user_models, INP t_model *library_models, INP boolean do_power, INP char *activity_file) {
	boolean *is_clock;
	int num_models;
	t_model *cur_model;
